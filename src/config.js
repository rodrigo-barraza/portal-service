...
export const SERVICES = {
  ...
  toolsApi:   { name: "Tools API",     url: TOOLS_API_URL,    healthPath: "/health",    environment: "Production",   visibility: "internal",  device: "synology",     serviceType: "API",              repo: "https://github.com/rodrigo-barraza/tools-api", dependsOn: [req("mongodb"), req("vault"), opt("prism")],   dockerProject: "tools-api" },
  ...
  retina:     { name: "Retina",        url: RETINA_URL,       healthPath: "/",          environment: "Production",   visibility: "external",  device: "synology",     serviceType: "Client",       repo: "https://github.com/rodrigo-barraza/retina",    hostname: "retina.rod.dev", dependsOn: [req("prism"), req("sessions"), opt("vault")],   dockerProject: "retina" },
