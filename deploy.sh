#!/bin/bash
# ============================================================
# API — Build & Deploy to Synology NAS
#
...
NAS_COMPOSE_DIR="/volume1/docker/api"     # Synology path where compose lives
NAS_SMB_DIR="/mnt/k/api"                 # Fallback: Windows SMB mount
...
echo -e "${CYAN}${BOLD}  🔌 API — Deploy to Synology${RESET}"
if $DRY_RUN; then
